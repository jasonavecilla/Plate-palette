...
function RecipeModal({recipe, rating, numReviews}) {
    ...
    const categoryElements = recipe.topics.map(topic => (
        <span className="mr-1 text-xs border bg-gray-400 rounded-full p-1">{topic.name}</span>
    ))
                        ...
                        <div>
                            ...
                            <div className='sm:grid sm:grid-cols-3 '>
                                <div className="sm:col-span-2">
                                    {/* title */}
                                    <h3 className="text-2xl font-semibold text-gray-800  mb-1 ">{recipe.name}</h3>
                                </div>
                            ...
                            {/* nutrition table */}
                            <div>
                                <h3 className="text-lg font-semibold text-gray-800 mt-4">Nutrition</h3>
