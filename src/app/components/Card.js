      ...
      <a className="group sm:relative sm:block" href="#">
        ...
        <div className="grow">
          <div className="p-4 flex flex-col h-full sm:p-6 ">
            <h3 className="text-lg sm:text-2xl font-semibold dark:text-white group-hover:text-blue-500 sm:text-white sm:group-hover:text-white/[.8] sm:absolute sm:bottom-16  sm:z-10 ">
              {blog.title}
            </h3>

            <p className="mt-2 dark:text-white sm:hidden">{blog.summary}</p>

            <div className="mt-5 sm:mt-auto sm:absolute sm:top-5  sm:z-10">
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <img
                    className="h-[2.875rem] w-[2.875rem] rounded-full sm:border-2 sm:border-white object-cover"
                    src={blog.avatar}
                    alt={blog.author}
                  />
                </div>
