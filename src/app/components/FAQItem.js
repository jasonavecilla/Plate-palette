  ...
  return (
    <>
        <div className="hs-accordion hs-accordion-active:bg-peach-500 rounded-xl p-6" id="hs-basic-with-title-and-arrow-stretched-heading-two">
            <button className="hs-accordion-toggle group pb-3 inline-flex items-center justify-between gap-x-3 w-full md:text-lg font-semibold text-left text-blue-700 transition hover:text-blue-500" aria-controls="hs-basic-with-title-and-arrow-stretched-collapse-two">
                {faq.question}
