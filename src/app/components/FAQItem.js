...
export default function FAQItem({ faq }) {
  return (
    <>
      <div
        className="hs-accordion hs-accordion-active:bg-blue-400 rounded-xl p-6"
      ...
      >
        ...
        >
          ...
          <svg
            className="hs-accordion-active:block hidden w-3 h-3 text-blue-600 group-hover:text-blue-500"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            fill="none"
